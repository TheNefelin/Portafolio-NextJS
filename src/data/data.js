...
export const myLinks = [
  ...
  // },
  {
    ...
    links: [
      ...
      {
        nombre: "YouTube CodelyTV",
        link: "https://www.youtube.com/@CodelyTV/",
        idLinkGrupo: 2,
        estado: true
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      {
        nombre: "SocialSVG",
        link: "https://www.svgrepo.com/collection/social-and-company-colored-logo-icons/",
        idLinkGrupo: 4,
        estado: true
      },
      {
        nombre: "Convert to Icon",
  ...
  },
  {
    ...
    links: [
      ...
      {
        nombre: "LinkedIn",
        link: "https://www.linkedin.com/in/nefelin/",
        idLinkGrupo: 5,
        estado: true
      },
      {
...
export const myProjects = [
  ...
  },
  {
    ...
    caratula: "07-DHT.png",
    caratulaIndex: 7,
    lenguajes: ["04-l-vbdot.png"],
    lenguajesIndex: [4],
    tecnologias: ["01-t-dotnet.svg"],
    tecnologiasIndex: [1],
    web: [],
    gitHub: [
  ...
  },
  {
    ...
    orden: 5,
    caratula: "05-el-cubo-v2.jpg",
    caratulaIndex: 5,
    lenguajes: ["00-l-csharp.svg"],
    lenguajesIndex: [0],
    tecnologias: ["07-t-unity.png", "09-t-vs-studio.svg"],
    tecnologiasIndex: [9, 7],
    web: [
      { nombre: "Download Link ", link: "https://drive.google.com/drive/folders/1qttZk_iN8fHYVjHqI6_VLS4nyT4fTkyu?usp=drive_link" },
    ],
    gitHub: []
  },
  {
